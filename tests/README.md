...
- Доступен vendored Codex companion через `bin/codex-dispatch`; выполнен `codex login`
...
bash "$PLUGIN_ROOT/tests/smoke/test-codex-dispatch.sh"
